...
var planCmd = &cobra.Command{
    ...
    # Use custom state file with plan output
    smurf stf plan --state=prod.tfstate -out=prod-plan.tfplan
...
func init() {
	...
	planCmd.Flags().StringVar(&planOut, "out", "", "Save the generated plan to a file for later application")
