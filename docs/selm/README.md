...
| `init` | Create a default smurf.yaml file with selm configuration |
...
| `plugin list` | List all installed Helm plugins |
| `plugin uninstall` | Uninstall one or multiple Helm plugins |
