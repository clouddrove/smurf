...
- Execute Terraform commands such as init, plan, apply, output, drift, validate, destroy, and format.
- Use the provision command to perform init, validate, and apply in a single step.
